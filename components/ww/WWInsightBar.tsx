  ...
  return (
    <AnimatePresence mode="wait">
        <motion.div 
            ...
            className="w-full bg-white/40 backdrop-blur-3xl border border-white/60 rounded-3xl p-6 relative flex flex-col md:flex-row gap-6 md:gap-8 items-center md:items-stretch group/insight hover:-translate-y-1 transition-all duration-500 overflow-visible" style={{ boxShadow: `0 0 50px -10px ${accentColor}40, inset 0 2px 20px rgba(255,255,255,0.8)` }}
        >
            {/* Top Glow Edge */}
            ...
            <div className="absolute top-0 left-[15%] w-32 h-[4px] blur-[4px] opacity-100 z-20 pointer-events-none mix-blend-screen" style={{ backgroundColor: accentColor }}></div>
            <div className="absolute top-0 left-[15%] w-16 h-[2px] blur-[1px] opacity-100 z-20 pointer-events-none bg-white"></div>
            <div className="absolute top-0 right-[25%] w-48 h-[6px] blur-[6px] opacity-80 z-20 pointer-events-none mix-blend-screen" style={{ backgroundColor: accentColor }}></div>
                    ...
                    <>
                        ...
                        <div className="flex flex-col items-center justify-center min-w-[120px] relative z-10 pb-4 md:pb-0 transition-transform duration-500 group-hover/insight:scale-105">
                            ...
                            <div className="relative">
                                <span className="text-5xl font-black tracking-tighter mix-blend-multiply drop-shadow-sm transition-transform duration-500" style={{ color: accentColor }}>{powerLevel}</span>
                                <span className="absolute inset-0 text-5xl font-black tracking-tighter blur-[12px] opacity-0 mix-blend-multiply transition-opacity duration-500 group-hover/insight:opacity-80 group-hover/insight:animate-pulse" style={{ color: accentColor }}>{powerLevel}</span>
